...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  if (data.credentials.password === data.credentials.password_confirmation) {
	    ...
	    var errorTextUponPasswordMismatchFailure = 'Passwords do not match.  Please verify passwords match.';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameLogic = __webpack_require__(13);

	var errorTextUponSignUpFailure = 'User has already signed up.  Please sign in.';
	var errorTextUponIncorrectPasswordFailure = 'Password is incorrect.  Please type in correct password.';

	var welcomeText = 'Welcome!!!';
	var signUpOrSignInText = 'Please SIGN UP or SIGN IN!';
	var startNewGameText = 'Please start a NEW GAME!';
	var thankYouTextUponSignOutSuccess = 'Thank you for playing!!!';
	...
	var signInSuccess = function signInSuccess(ajaxResponse) {
	  ...
	  var userString = 'Welcome ' + store.user.email + '!!!';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var playerXWinsString = 'Player X WINS!!!';
	var playerOWinsString = 'Player O WINS!!!';
	var gameTiedString = 'TIE GAME!!';
	var startNewGameText = 'Please start a NEW GAME!';
	var playerAnotherGameString = 'Play another game?';

	// Requirement:  First player is 'X'
	var playerToken = 'X';
	var currentCellPosition = -1;
	var isCurrentGameActive = true;
	var validMoveCounter = 0; // Used to determine if game was a tie
	var foundWinningGameBoard = false;
	var foundTiedGameBoard = false;
	...
	var processClick = function processClick(event, cellPosition, cellValue) {
	...
	var isValidClick = function isValidClick(event, cellPosition, cellValue) {
	  ...
	  if (cellValue === ' ') {
	    ...
	    var gameBoardCellIdName = '#game-board-cell-' + cellPosition;
	    ...
	    api.updateGameState(gameDelta).then(ui.updateGameStateSuccess).catch(ui.updateGameStateFailure);
	...
	var processNextPlayersTurn = function processNextPlayersTurn() {
	...
	var clearGameBoard = function clearGameBoard() {
	  ...
	  for (var cellPosition = 0; cellPosition < gameBoardArray.length; cellPosition++) {
	    var gameBoardCellIdName = '#game-board-cell-' + cellPosition;
	...
	var checkforWinningGameBoard = function checkforWinningGameBoard() {
	  var foundWin = false;
	...
	var didPlayerXWinGame = function didPlayerXWinGame() {
	  var isWinner = false;

	  if (
	  // Check horizontals
	  gameBoardArray[0] === 'X' && gameBoardArray[1] === 'X' && gameBoardArray[2] === 'X' || gameBoardArray[3] === 'X' && gameBoardArray[4] === 'X' && gameBoardArray[5] === 'X' || gameBoardArray[6] === 'X' && gameBoardArray[7] === 'X' && gameBoardArray[8] === 'X' ||
	  // Check verticals
	  gameBoardArray[0] === 'X' && gameBoardArray[3] === 'X' && gameBoardArray[6] === 'X' || gameBoardArray[1] === 'X' && gameBoardArray[4] === 'X' && gameBoardArray[7] === 'X' || gameBoardArray[2] === 'X' && gameBoardArray[5] === 'X' && gameBoardArray[8] === 'X' ||
	  // Check diagonals
	  gameBoardArray[0] === 'X' && gameBoardArray[4] === 'X' && gameBoardArray[8] === 'X' || gameBoardArray[2] === 'X' && gameBoardArray[4] === 'X' && gameBoardArray[6] === 'X') {
	    isWinner = true;
	    return isWinner;
	  } else {
	    return isWinner;
	...
	var didPlayerOWinGame = function didPlayerOWinGame() {
	  var isWinner = false;

	  if (
	  // Check horizontals
	  gameBoardArray[0] === 'O' && gameBoardArray[1] === 'O' && gameBoardArray[2] === 'O' || gameBoardArray[3] === 'O' && gameBoardArray[4] === 'O' && gameBoardArray[5] === 'O' || gameBoardArray[6] === 'O' && gameBoardArray[7] === 'O' && gameBoardArray[8] === 'O' ||
	  // Check verticals
	  gameBoardArray[0] === 'O' && gameBoardArray[3] === 'O' && gameBoardArray[6] === 'O' || gameBoardArray[1] === 'O' && gameBoardArray[4] === 'O' && gameBoardArray[7] === 'O' || gameBoardArray[2] === 'O' && gameBoardArray[5] === 'O' && gameBoardArray[8] === 'O' ||
	  // Check diagonals
	  gameBoardArray[0] === 'O' && gameBoardArray[4] === 'O' && gameBoardArray[8] === 'O' || gameBoardArray[2] === 'O' && gameBoardArray[4] === 'O' && gameBoardArray[6] === 'O') {
	    isWinner = true;
	    return isWinner;
	  } else {
	    return isWinner;
	...
	var checkForTiedGameBoard = function checkForTiedGameBoard() {
	  if (validMoveCounter === 9 && foundWinningGameBoard === false) {
	    return true;
	  } else return false;
	};

	var showUserStats = function showUserStats() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createGameSuccess = function createGameSuccess(ajaxResponse) {
	...
	var showUserStatsSuccess = function showUserStatsSuccess(ajaxResponse) {
	  ...
	  var gamesPlayedString = 'You have played ' + ajaxResponse.games.length;
	...
	var showUserStatsFailure = function showUserStatsFailure(error) {
	...
	var indexGameSuccess = function indexGameSuccess(ajaxResponse) {
	...
	var indexGameFailure = function indexGameFailure(error) {
	...
	var showGameSuccess = function showGameSuccess(ajaxResponse) {
	...
	var showGameFailure = function showGameFailure(error) {
	...
	var updateGameStateSuccess = function updateGameStateSuccess(ajaxResponse) {
	...
	var updateGameStateFailure = function updateGameStateFailure(error) {
	...
	module.exports = {
	  ...
	  showUserStatsSuccess: showUserStatsSuccess,
	  showUserStatsFailure: showUserStatsFailure,
	  ...
	  updateGameStateSuccess: updateGameStateSuccess,
	  updateGameStateFailure: updateGameStateFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowUserStats = function onShowUserStats(event) {
	  event.preventDefault();
	  // console.log('show-stats ran!')

	  // Don't need to use data object here!
	  api.showUserStats().then(ui.showUserStatsSuccess).catch(ui.showUserStatsFailure);
	};

	var onIndexGame = function onIndexGame(event) {
	  event.preventDefault();
	  // console.log('index-game ran!')

	  // Don't need to use data object here!
	  api.indexGame().then(ui.indexGameSuccess).catch(ui.indexGameFailure);
	};
	...
	var onShowGame = function onShowGame(event) {
	  ...
	  // Don't need to use data object here!
	  api.showGame().then(ui.showGameSuccess).catch(ui.showGameFailure);
	};

	var onUpdateGameState = function onUpdateGameState(event) {
	  event.preventDefault();
	  // console.log('update-game-state ran!')

	  var data = getFormFields(this);
	  api.updateGameState(data).then(ui.updateGameStateSuccess).catch(ui.updateGameStateFailure);
	};
	...
	var onClickBoard = function onClickBoard(event) {
	  ...
	  var targetIdString = event.target.id; // Last character is cellPosition
	  var cellPosition = targetIdString.substr(targetIdString.length - 1);
	...
	var addHandlers = function addHandlers() {
	  ...
	  for (var cellPosition = 0; cellPosition < 9; cellPosition++) {
	    var gameBoardCellIdName = '#game-board-cell-' + cellPosition;
